from AESCryptography.AESencryptfunc import * #import AESencryptfunc module to use functions created for this program
...
def encrypt(data, key=0):
    ...
    while(len(PassPhrase)!=16):
        ...
        PassPhrase= "darksaint09" if key==0 else key #takes in user input of char, eg. "Iwanttolearnkung"
