from AESCryptography.AESdecryptfunc import * #import AESdecryptfunc module to use functions created for this program
...
def decrypt(ciphertext, key):
    ...
    while(len(PassPhrase)!=16):
        ...
        PassPhrase= "darksaint09" if key==0 else key
